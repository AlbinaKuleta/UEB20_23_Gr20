...
use UEBI2db;
create table user (uid integer, uname nvarchar(30), surname varchar(40), password nvarchar(25), email nvarchar(50), adress nvarchar(30));
...
create table userProduct (uid integer, pid integer, quantity integer, unit nvarchar(20));
create table cart (uid integer, pid integer, total decimal(8,2));

insert into products
values 
(1, 'fish eggs', 50.00, load_file("C:\xampp\htdocs\WEB2\UEB20_23_Gr20\images\fisheggs.png")),
(2, 'goat chesse', 35.00, load_file("C:\xampp\htdocs\WEB2\UEB20_23_Gr20\images\goat chesse.png")),
