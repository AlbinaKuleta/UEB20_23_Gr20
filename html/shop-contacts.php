        ...
        <div class="row margin-bottom-40">
          ...
          <div class="sidebar col-md-3 col-sm-3">
            ...
            <address>
              Prishtine<br>
               Kosove<br>
              <abbr title="Phone">P:</abbr>+383 48 222 333<br>
            </address>
            <address>
              <strong>Email</strong><br>
              <a href="mailto:info@organic.com">info@organic.com</a><br>
          ...
          <div class="col-md-9 col-sm-9">
            ...
            <div class="content-page">
              ...
              <p>Here is a contact form for you. You can contact us for more infos. The email adress is reuqired, so we know more about you.
                If you have something to ask us, something to add, of even any critic you are welcomed, we are gonna accept them without any
              doubt. We value you. You make us better!  </p>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6 pre-footer-col">
            ...
            <a class="twitter-timeline" href="https://twitter.com/twitterapi" data-tweet-limit="2" data-theme="dark" data-link-color="#57C8EB" data-widget-id="455411516829736961" data-chrome="noheader nofooter noscrollbar noborders transparent"></a>      
          </div>
          <!-- END TWITTER BLOCK -->
