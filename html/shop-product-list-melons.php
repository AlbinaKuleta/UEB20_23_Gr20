...
<head>
  <meta charset="utf-8">
  <title>Fresh Vegetables| Organic Shop </title>

  <meta content="width=device-width, initial-scale=1.0" name="viewport">
  <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">

  <meta content="Organic Shop  description" name="description">
  <meta content="Organic Shop keywords" name="keywords">
...
<body class="ecommerce">
    ...
    <div class="title-wrapper">
      <div class="container"><div class="container-inner">
        <h1><span>FRUITS</span> CATEGORY</h1>
          ...
          <div class="col-md-9 col-sm-7">
            ...
            <div class="row product-list">
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="assets/pages/img/products/Fruits/Melons/cantaloupe.png" class="img-responsive" alt="cantaloupe">
                    <div>
                      <a href="assets/pages/img/products/Fruits/Melons/cantaloupe.png" class="btn btn-default fancybox-button">Zoom</a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
                  <h3><a href="shop-item.html">Cantaloupe</a></h3>
                  <div class="pi-price">$9.00</div>
                  <a href="javascript:;" class="btn btn-default add2cart">Add to cart</a>
                </div>
              </div>
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="assets/pages/img/products/Fruits/Melons/Golden Melon.png" class="img-responsive" alt="Golden Melon">
                    <div>
                      <a href="assets/pages/img/products/Fruits/Melons/Golden Melon.png" class="btn btn-default fancybox-button">Zoom</a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
                  <h3><a href="shop-item.html">Golden Melon</a></h3>
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="assets/pages/img/products/Fruits/Melons/Honeydew.png" class="img-responsive" alt="Honeydew">
                    <div>
                      <a href="assets/pages/img/products/Fruits/Melons/Honeydew.png"class="btn btn-default fancybox-button">Zoom</a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
                  <h3><a href="shop-item.html">Honeydew</a></h3>
                  <div class="pi-price">$17.00</div>
                  <a href="javascript:;" class="btn btn-default add2cart">Add to cart</a>
                </div>
              </div>              
            ...
            <div class="row product-list">
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="assets/pages/img/products/Fruits/Melons/watermelon.png" class="img-responsive" alt="watermelon">
                    <div>
                        <a href="assets/pages/img/products/Fruits/Melons/watermelon.png"class="btn btn-default fancybox-button">Zoom</a>
                        <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
                  <h3><a href="shop-item.html">Watermelon</a></h3>
                  <div class="pi-price">$29.00</div>
                  <a href="javascript:;" class="btn btn-default add2cart">Add to cart</a>
                </div>
              </div>
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="assets/pages/img/products/Fruits/grape/Freshblackseedlessgrapes.png" class="img-responsive" alt="Freshblackseedlessgrapes">
                    <div>
                        <a href="assets/pages/img/products/Fruits/grape/Freshblackseedlessgrapes.png" class="btn btn-default fancybox-button">Zoom</a>
                        <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
                  <h3><a href="shop-item.html">Fresh Black Seedless Grapes</a></h3>
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="assets/pages/img/products/Fruits/grape/Freshgreenseedlessgrapes.png" class="img-responsive" alt="Freshgreenseedlessgrapes.png">
                    <div>
                        <a href="assets/pages/img/products/Fruits/grape/Freshgreenseedlessgrapes.png"class="btn btn-default fancybox-button">Zoom</a>
                        <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
                  <h3><a href="shop-item.html"> Fresh Green Seedless Grapes </a></h3>
                  <div class="pi-price">$29.00</div>
                  <a href="javascript:;" class="btn btn-default add2cart">Add to cart</a>
                </div>
              </div>              
            ...
            <div class="row product-list">
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="assets/pages/img/products/Fruits/grape/freshredseedlessgrapes.png" class="img-responsive" alt="red Fresh Seedless Grapes ">
                    <div>
                        <a href="assets/pages/img/products/Fruits/Berries/redcurrants.png"class="btn btn-default fancybox-button">Zoom</a>
                        <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
                  <h3><a href="shop-item.html"> Fresh Red Seedless Grapes </a></h3>
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="assets/pages/img/products/Fruits/grape/merlo.png" class="img-responsive" alt="Merlot">
                    <div>
                        <a href="assets/pages/img/products/Fruits/grape/merlo.png" class="btn btn-default fancybox-button">Zoom</a>
                        <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
                  <h3><a href="shop-item.html">Merlot</a></h3>
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="assets/pages/img/products/Fruits/grape/cottoncandygrapes.png" class="img-responsive" alt="cottoncandygrapes">
                    <div>
                        <a href="assets/pages/img/products/Fruits/grape/cottoncandygrapes.png" class="btn btn-default fancybox-button">Zoom</a>
                        <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
                  <h3><a href="shop-item.html">Cotton Candy Grapes</a></h3>
                  <div class="pi-price">$21.00</div>
                  <a href="javascript:;" class="btn btn-default add2cart">Add to cart</a>
