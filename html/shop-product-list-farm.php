            ...
            <div class="row product-list">
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="product-item">
                  ...
                  <h3><a href="shop-item.php">Cheese</a></h3>
                  <div class="pi-price">$17.00</div>
                  <a href="javascript:;" class="btn btn-default add2cart">Add to cart</a>
                </div>
              </div>              
            ...
            <div class="row product-list">
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="product-item">
                  ...
                  <h3><a href="shop-item.php">Bacon</a></h3>
                  <div class="pi-price">$29.00</div>
                  <a href="javascript:;" class="btn btn-default add2cart">Add to cart</a>
                </div>
              </div>
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="product-item">
                  ...
                  <h3><a href="shop-item.php">Chicken Drumsticks</a></h3>
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="product-item">
                  ...
                  <h3><a href="shop-item.php">Ham</a></h3>
                  <div class="pi-price">$29.00</div>
                  <a href="javascript:;" class="btn btn-default add2cart">Add to cart</a>
                </div>
              </div>              
            ...
            <div class="row product-list">
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="product-item">
                  ...
                  <h3><a href="shop-item.php">Lambchops</a></h3>
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="product-item">
                  ...
                  <h3><a href="shop-item.php">Roasrbeef</a></h3>
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="product-item">
                  ...
                  <h3><a href="shop-item.php">Steakbeef</a></h3>
                  <div class="pi-price">$21.00</div>
                  <a href="javascript:;" class="btn btn-default add2cart">Add to cart</a>
