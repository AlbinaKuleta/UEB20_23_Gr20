...
<!-- Head END -->
    ...
    <div class="title-wrapper">
      <div class="container"><div class="container-inner">
        <h1><span>From Our Farm</span> CATEGORY</h1>
          ...
          <div class="col-md-9 col-sm-7">
            ...
            <div class="row product-list">
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="assets/pages/img/products/Fruits/Farm/milk.png" class="img-responsive" alt="milk">
                    <div>
                      <a href="assets/pages/img/products/Fruits/Farm/milk.png" class="btn btn-default fancybox-button">Zoom</a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
                  <h3><a href="shop-item.html">Milk</a></h3>
                  <div class="pi-price">$9.00</div>
                  <a href="javascript:;" class="btn btn-default add2cart">Add to cart</a>
                </div>
              </div>
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="assets/pages/img/products/Fruits/Farm/eggs.png" class="img-responsive" alt="eggs">
                    <div>
                      <a href="assets/pages/img/products/Fruits/Farm/farmeggs.png" class="btn btn-default fancybox-button">Zoom</a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
                  <h3><a href="shop-item.html">Eggs</a></h3>
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="assets/pages/img/products/Fruits/Farm/cheese.png" class="img-responsive" alt="cheese">
                    <div>
                      <a href="assets/pages/img/products/Fruits/Farm/cheese.png"class="btn btn-default fancybox-button">Zoom</a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
                  <h3><a href="shop-item.html">Cheese</a></h3>
                  <div class="pi-price">$17.00</div>
                  <a href="javascript:;" class="btn btn-default add2cart">Add to cart</a>
                </div>
              </div>              
            ...
            <div class="row product-list">
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="assets/pages/img/products/Fruits/Farm/bacon.png" class="img-responsive" alt="bacon">
                    <div>
                        <a href="assets/pages/img/products/Fruits/Farm/bacon.png"class="btn btn-default fancybox-button">Zoom</a>
                        <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
                  <h3><a href="shop-item.html">Bacon</a></h3>
                  <div class="pi-price">$29.00</div>
                  <a href="javascript:;" class="btn btn-default add2cart">Add to cart</a>
                </div>
              </div>
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="assets/pages/img/products/Fruits/Farm/chicken_drumsticks.png" class="img-responsive" alt="chicken_drumsticks">
                    <div>
                        <a href="assets/pages/img/products/Fruits/Farm/chicken_drumsticks.png" class="btn btn-default fancybox-button">Zoom</a>
                        <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
                  <h3><a href="shop-item.html">Chicken Drumsticks</a></h3>
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="assets/pages/img/products/Fruits/Farm/ham.png" class="img-responsive" alt="Ham">
                    <div>
                        <a href="assets/pages/img/products/Fruits/Farm/ham.png"class="btn btn-default fancybox-button">Zoom</a>
                        <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
                  <h3><a href="shop-item.html">Ham</a></h3>
                  <div class="pi-price">$29.00</div>
                  <a href="javascript:;" class="btn btn-default add2cart">Add to cart</a>
                </div>
              </div>              
            ...
            <div class="row product-list">
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="assets/pages/img/products/Fruits/Farm/lambchops.png" class="img-responsive" alt="Lambchops">
                    <div>
                        <a href="assets/pages/img/products/Fruits/Farm/lambchops.png"class="btn btn-default fancybox-button">Zoom</a>
                        <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
                  <h3><a href="shop-item.html">Lambchops</a></h3>
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="assets/pages/img/products/Fruits/Farm/roasrbeef.png" class="img-responsive" alt="roasrbeef">
                    <div>
                        <a href="assets/pages/img/products/Fruits/Farm/roasrbeef.png" class="btn btn-default fancybox-button">Zoom</a>
                        <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
                  <h3><a href="shop-item.html">Roasrbeef</a></h3>
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="assets/pages/img/products/Fruits/Farm/steakbeef.png" class="img-responsive" alt="steakbeef">
                    <div>
                        <a href="assets/pages/img/products/Fruits/Farm/steakbeef.png" class="btn btn-default fancybox-button">Zoom</a>
                        <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
                  <h3><a href="shop-item.html">Steakbeef</a></h3>
                  <div class="pi-price">$21.00</div>
                  <a href="javascript:;" class="btn btn-default add2cart">Add to cart</a>
