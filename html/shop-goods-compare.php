            ...
            <div class="goods-page">
              <div class="goods-data compare-goods clearfix">
                <div class="table-wrapper-responsive">                
                  <table summary="Product Details">                  
                    <tr>
                      ...
                      <td class="compare-item">
                        <a href="javascript:;"><img src="../images/fresh-fruits1.jpg" alt="Fresh fruits"></a>
                        <h3><a href="javascript:;">Juicy Oranges</a></h3>
                        <strong class="compare-price"><span>$</span>47.00</strong>
                      </td>
                      <td class="compare-item">
                        <a href="javascript:;"><img src="../images/fresh-fruits2.jpg" alt="Fresh fruits"></a>
                        <h3><a href="javascript:;">Fresh Lemons</a></h3>
                  ...
                  <p class="padding-top-20"><strong>Notice:</strong> These products are fresh products that we sell. Drinking bio-products is highly recommended! </p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 steps-block-col">
            ...
            <div>
              <h2>Free shipping</h2>
              <em>Express delivery within 1 hour</em>
            </div>
            <span>&nbsp;</span>
          </div>
          <div class="col-md-4 steps-block-col">
