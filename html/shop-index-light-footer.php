          ...
          <div class="col-md-12 sale-product">
            ...
            <div class="owl-carousel owl-carousel5">
              <div>
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="../images/sunflowerseeds.png" class="img-responsive" alt="Sunflower seeds">
                    <div>
                      <a href="../images/sunflowerseeds.png" class="btn btn-default fancybox-button">Zoom</a>
              ...
              <div>
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="../images/pumpkinseeds.png" class="img-responsive" alt="pumpkinseeds">
                    <div>
                      <a href="../images/pumpkinseeds.png" class="btn btn-default fancybox-button">Zoom</a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
              ...
              <div>
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="../images/liri seeds.png" class="img-responsive" alt="liriseeds">
                    <div>
                      <a href="../images/liri seeds.png" class="btn btn-default fancybox-button">Zoom</a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
              ...
              <div>
                  <div class="product-item">
                    <div class="pi-img-wrapper">
                      <img src="../images/chiaseeds.png" class="img-responsive" alt="chiaseeds">
                      <div>
                        <a href="../images/chiaseeds.png" class="btn btn-default fancybox-button">Zoom</a>
                        <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                      </div>
                    </div>
                    <h3><a href="javascript:;">Chia seeds</a></h3>
              ...
              <div>
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="../images/almonds.png" class="img-responsive" alt="almonds">
                    <div>
                      <a href="../images/almonds.png" class="btn btn-default fancybox-button">Zoom</a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
          ...
          <div class="col-md-9 col-sm-8">
            <div class="owl-carousel owl-carousel3">
              ...
              <div>
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="../images/onion.png" class="img-responsive" alt="onion">
                    <div>
              ...
              <div>
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="../images/cabbage.png" class="img-responsive" alt="cabbage">
                    <div>
                      <a href="../images/cabbage.png" class="btn btn-default fancybox-button">Zoom</a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
              ...
              <div>
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="../images/tomato.png" class="img-responsive" alt="tomato">
                    <div>
                      <a href="../images/tomato.png" class="btn btn-default fancybox-button">Zoom</a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
          ...
          <div class="col-md-6 two-items-bottom-items">
            <div class="owl-carousel owl-carousel2">
              ...
              <div>
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="../images/peaches.png" class="img-responsive" alt="peaches">
                    <div>
                      <a href="../images/peaches.png" class="btn btn-default fancybox-button">Zoom</a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
              ...
              <div>
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="../images/blackberries.png" class="img-responsive" alt="blackberries">
                    <div>
                      <a href="../images/blackberries.png" class="btn btn-default fancybox-button">Zoom</a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
              ...
              <div id="myCarousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                  <div class="item active">
                    <img src="../images/indicators4.png" class="img-responsive" alt="indicator4">
                  </div>
                  <div class="item">
                    <img src="../images/indicators5.png" class="img-responsive" alt="indicator5">
                  </div>
                  <div class="item">
                    <img src="../images/indicators6.png" class="img-responsive" alt="indicator6">
                  </div>
                </div>
              </div>
            </div>
