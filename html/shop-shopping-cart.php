              ...
              <div class="goods-data clearfix">
                ...
                <table summary="Shopping cart">
                  ...
                  <tr>
                    <td class="goods-page-image">
                      <a href="javascript:;"><img src="assets/pages/img/products/Fruits/Berries/strawberry.png" alt="strawberry"></a>
                    </td>
                    <td class="goods-page-description">
                      <h3><a href="javascript:;">strawberry</a></h3>
                      <p><strong>Item 1</strong> - Quantity: 3 Kg</p>
                    ...
                    <td class="goods-page-price">
                      <strong><span>$</span>5.00</strong>
                    </td>
                    <td class="goods-page-total">
                      <strong><span>$</span>15.00</strong>
                    </td>
                  ...
                  <tr>
                    <td class="goods-page-image">
                      <a href="javascript:;"><img src="assets/pages/img/products/Fruits/Farm/farmeggs.png" alt="Eggs"></a>
                    </td>
                    <td class="goods-page-description">
                      <h3><a href="javascript:;">Eggs</a></h3>
                      <p><strong>Item 2</strong> Quantity: 2 Kg</p>
                      <em>More info is here</em>
                    </td>
                    <td class="goods-page-ref-no">
                      javc2133
                    ...
                    <td class="goods-page-price">
                      <strong><span>$</span>7.00</strong>
                    </td>
                    <td class="goods-page-total">
                      <strong><span>$</span>14.00</strong>
                    </td>
                    <td class="del-goods-col">
                      <a class="del-goods" href="javascript:;">&nbsp;</a>
                    </td>
                ...
                <div class="shopping-total">
                  <ul>
                    <li>
                      <em>Sub total</em>
                      <strong class="price"><span>$</span>29.00</strong>
                    </li>
                    <li>
                      <em>Shipping cost</em>
                    ...
                    <li class="shopping-total-price">
                      <em>Total</em>
                      <strong class="price"><span>$</span>31.00</strong>
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <div class="col-md-12 col-sm-12">
            ...
            <div class="owl-carousel owl-carousel4">
              <div>
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="assets/pages/img/products/Fruits/dragonfruit.png" class="img-responsive" alt="dragonfruit">
                    <div>
                      <a href="assets/pages/img/products/Fruits/dragonfruit.png" class="btn btn-default fancybox-button">Zoom</a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
                  <h3><a href="shop-item.html">Dragon Fruit</a></h3>
                  <div class="pi-price">$29.00</div>
                  <a href="javascript:;" class="btn btn-default add2cart">Add to cart</a>
