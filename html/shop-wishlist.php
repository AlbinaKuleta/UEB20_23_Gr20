            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 additional-shop-info">
                    <ul class="list-unstyled list-inline">
                        <li><i class="fa fa-phone"></i><span>+383 45 800 800 </span></li>
                        <!-- BEGIN CURRENCIES -->
      ...
      <div class="container">
        ...
        <div class="top-cart-block">
            <div class="top-cart-info">
              ...
              <a href="javascript:void(0);" class="top-cart-info-value">$40</a>
            </div>
            ...
            <div class="top-cart-content-wrapper">
              <div class="top-cart-content">
                <ul class="scroller" style="height: 250px;">
                  <li>
                    <a href="shop-item.html"><img src="../images/ananas.png" alt="Ananas bio" width="37" height="34"></a>
                    <span class="cart-content-count">x 1</span>
                    <strong><a href="shop-item.html">Ananas bio </a></strong>
                    <em>$5</em>
                ...
                <table summary="Shopping cart">
                  ...
                  <tr>
                    <td class="goods-page-image">
                      <a href="javascript:;"><img src="../images/blog1.jpeg" alt="fruta "></a>
                    </td>
                    <td class="goods-page-description">
                      <h3><a href="javascript:;">Mix fruta </a></h3>
                      <p><strong>Item 1</strong> - Amount : 300 KAL </p>
                  ...
                  <tr>
                    <td class="goods-page-image">
                      <a href="javascript:;"><img src="../images/blog3.jpg" alt="proteina boost"></a>
                    </td>
                    <td class="goods-page-description">
                      <h3><a href="javascript:;">Protein boost </a></h3>
                      <p><strong>Item 1</strong> - Amount : 600 KAL</p>
                      <em>More info is here</em>
                    </td>
                    <td class="goods-page-stock">
                      In Stock
